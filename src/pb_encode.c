...
bool pb_encode_array(pb_ostream_t *stream, json_t *protos, json_t *proto, json_t *array);
...
bool checkreturn pb_write(pb_ostream_t *stream, const uint8_t *buf,
        size_t count) {
...
bool checkreturn pb_encode_array(pb_ostream_t *stream, json_t *protos,
...
bool checkreturn pb_encode_proto(pb_ostream_t *stream, json_t *protos,
...
/* Encode field header by manually specifing wire type. You need to use this if
 * you want to write out packed arrays from a callback field. */
bool checkreturn pb_encode_tag(pb_ostream_t *stream, int wiretype,
...
/* Encode a string or bytes type field. For strings, pass strlen(s) as size. */
bool checkreturn pb_encode_string(pb_ostream_t *stream, const uint8_t *buffer,
        size_t size) {
...
/* Eecode submessage in __messages protos */
bool checkreturn pb_encode_submessage(pb_ostream_t *stream, json_t *protos,
        json_t *value) {
